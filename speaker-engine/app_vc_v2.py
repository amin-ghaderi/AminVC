...
def make_convert_voice_v2_gradio_fn(vc_wrapper):
    """Named Gradio handler with explicit 11 inputs (matches UI component list)."""

    def convert_voice_v2_gradio(
        source_audio_path,
        target_audio_path,
        diffusion_steps,
        length_adjust,
    ...
    return convert_voice_v2_gradio
...
def main(args):
    ...
    gr.Interface(
        fn=make_convert_voice_v2_gradio_fn(vc_wrapper),
